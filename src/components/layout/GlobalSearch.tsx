...
const access: Record<string, { name: string; path: string }[]> = {
  ...
  Clerk: [{ name: 'trainees', path: '/profile' }, { name: 'staff', path: '/staff' }, { name: 'batches', path: '/batches' }, { name: 'subject_master', path: '/subjects' }, { name: 'staff_subjects', path: '/subject-assignment' }, { name: 'staff_attendance', path: '/staff-attendance' }, { name: 'absentRecords', path: '/absent-management' }, { name: 'fptRecords', path: '/test-records' }, { name: 'weeklyTestRecords', path: '/test-records' }, { name: 'medicalRecords', path: '/medical-register' }, { name: 'staff_leave', path: '/staff-leave' }],
  Ustad: [{ name: 'trainees', path: '/ustad' }, { name: 'staff', path: '/staff' }, { name: 'subject_master', path: '/training-schedule' }, { name: 'training_schedule', path: '/training-schedule' }, { name: 'staff_leave', path: '/staff-leave' }],
};
