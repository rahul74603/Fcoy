...
const access: Record<string, { name: string; path: string }[]> = {
  ...
  Clerk: [{ name: 'trainees', path: '/profile' }, { name: 'staff', path: '/staff-management' }, { name: 'batches', path: '/batches' }, { name: 'subject_master', path: '/subjects' }, { name: 'staff_subjects', path: '/subject-assignment' }, { name: 'attendance', path: '/attendance' }, { name: 'absent_records', path: '/absent-management' }],
  Ustad: [{ name: 'trainees', path: '/ustad' }, { name: 'staff', path: '/staff-management' }, { name: 'subject_master', path: '/subjects' }, { name: 'staff_subjects', path: '/subject-assignment' }, { name: 'attendance', path: '/attendance' }, { name: 'test_records', path: '/test-records' }, { name: 'training_schedules', path: '/training-schedule' }],
};
