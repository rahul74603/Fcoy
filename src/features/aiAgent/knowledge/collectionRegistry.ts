...
export const COLLECTIONS: CollectionDef[] = [
  ...
  // ══════════════ TRAINEE DOMAIN ══════════════
  {
    ...
    fields: [
      ...
      { name: 'trainingStatus', kind: 'enum', label: 'Training Status',
        values: ['active','relegated','completed','discharged'],
        synonyms: ['relegated', 'relegate', 'status'] },
      { name: 'relegateId', kind: 'id', label: 'RelID', synonyms: ['relid'] },
      { name: 'isRelegatedIntake', kind: 'bool', label: 'Relegated Intake' },
    ],
  },
  ...
  {
    name: 'relegations',
    description: 'Relegation register — RelID, awaiting rejoin pool, chest+R rejoin into a later batch. Destination batch is UNKNOWN at relegate time.',
    synonyms: ['relegate', 'relegation', 'relid', 'rel id', 'rejoin', 'next batch', 'injury batch',
               'saksham nahi', 'relegated', 'chest r'],
    batchScoped: false,
    linkField: 'fromChestNo',
    titleField: 'traineeName',
    domain: 'trainee',
    fields: [
      { name: 'relegateId', kind: 'id', label: 'RelID', synonyms: ['relid', 'relegate id'] },
      { name: 'traineeName', kind: 'text', label: 'Trainee Name' },
      { name: 'fromChestNo', kind: 'id', label: 'Original Chest' },
      { name: 'fromBatchNumber', kind: 'text', label: 'From Batch' },
      { name: 'toBatchNumber', kind: 'text', label: 'Joined Batch' },
      { name: 'toChestNo', kind: 'id', label: 'New Chest (R)' },
      { name: 'reason', kind: 'text', label: 'Reason', synonyms: ['injury', 'medical', 'wajah'] },
      { name: 'status', kind: 'enum', label: 'Status', values: ['awaiting_rejoin', 'rejoined', 'cancelled'] },
      DATEF('relegatedAt', 'Relegated At'),
      DATEF('rejoinedAt', 'Rejoined At'),
    ],
  },
