...
const [staffLoading, setStaffLoading] = useState(false);
  ...
  const totalRecoveryDue = pendingRecoveries.reduce((s, r) => s + (r.dueAmount || 0), 0);
  ...
  // ── NEW: Handle absent trainee row click ──
  const handleAbsentClick = (e: React.MouseEvent, trainee: TraineeInfo) => {
    e.stopPropagation();
