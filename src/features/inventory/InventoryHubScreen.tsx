...
import { AlertTriangle, Archive, ArrowRight, Boxes, CheckCircle2, CircleDollarSign, Package, RefreshCw, ShieldAlert, ShoppingCart, Users } from 'lucide-react';
...
export const InventoryHubScreen: React.FC = () => {
  ...
  const totalIssued = kitRows.reduce((s, r) => s + r.issued, 0);
  const lowStock = kitRows.filter(r => r.available <= r.min).length;
